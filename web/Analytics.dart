...
class Analytics {
    ...
    void levelStart(chapter,level) {
        ...
        timers[chapter.toString()+"."+level.toString()] = time.millisecondsSinceEpoch / 1000;
    }
    ...
    void levelComplete(chapter, level, nStatic, nDynamic, stars) {
        ...
        if(timers[chapter.toString()+"."+level.toString()]!=null) {
            ...
            time = t.millisecondsSinceEpoch / 1000 - s;
        }
        object.callMethod('levelComplete', [chapter, level, nStatic, nDynamic, stars, time]);
    }
}
