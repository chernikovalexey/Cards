...
locale.every_day_attempts = 'каждый день вы получаете по 125 бесплатных попыток';
...
locale.instruction_apply = '<b>Для "вперед" и "назад",</b> нажмите комбинацию Ctrl+Shift.';
locale.instruction_apply_mac = '<b>Для "вперед" и "назад",</b> нажмите комбинацию Cmd+Shift.';
locale.instruction_undo = '<b>Чтобы отменить последнее действие,</b> нажмите комбинацию Ctrl+Z';
locale.instruction_undo_mac = '<b>Чтобы отменить последнее действие,</b> нажмите комбинацию Cmd+Z';
locale.instruction_remove = '<b>Чтобы убрать блок,</b> расположите мышь на над ним и нажмите правую кнопку или Delete';
locale.ok = 'OК';
...
locale.surely_want = "Будет показано прохождение уровня.";
locale.restart_question = "Начать уровень заново?";
locale.surely_want_restart = "Все блоки будут удалены.";
...
locale.dynamic_obstacles_tooltip = "Красные препятствия падают";
