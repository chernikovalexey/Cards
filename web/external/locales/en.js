...
locale.every_day_attempts = 'every day you acquire 125 free attempts';
...
locale.instruction_apply = '<b>To apply or rewind,</b> press Ctrl+Shift.';
locale.instruction_apply_mac = '<b>To apply or rewind,</b> press Cmd+Shift.';
locale.instruction_undo = '<b>To undo the most recent action,</b> press Ctrl+Z.';
locale.instruction_undo_mac = '<b>To undo the most recent action,</b> press Cmd+Z.';
locale.instruction_remove = '<b>To remove a block,</b> place mouse over it and right-click or press Delete.';
locale.ok = 'OK';
...
locale.surely_want = "The passage of the level will be shown.";
locale.restart_question = "Restart the level?";
locale.surely_want_restart = "All blocks will be removed.";
...
locale.completed_level_4 = "I've completed the level {0} in Two Cubes first among my friends!";
